...
<body class="bg-dark">
    ...
    <div class="bg-info py-4">
        ...
        <div class="container text-center">
            <form action="./actions/login.php" method="POST" enctype="multipart/form_data">
                <div class="mb-3">
                ...
                <p>Don't hava an acciunt?<a href="./partials/registration.php" class="text-white">Register here</a></p>
            </form
        </div>
    </div>
</body>
